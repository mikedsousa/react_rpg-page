		...
		<>
			<section className={styles.section}>
				...
				<div>
					...
					<p>
						Há três anos me aventuro nas práticas de lidar com a
						Dama Fortuna, mais conhecida como
						<Span color="blue"> RPG</Span>. Ao longo desse tempo,
						narrei sistemas como
						<Span color="red"> Dungeons & Dragons</Span>,
						<Span color="green"> Mutante: Ano Zero</Span> e
						<Span color="purple"> Vaesen RPG</Span>. Meu objetivo?
						Recrutar novos jogadores para a arte de rolar dados!
					</p>
				</div>
			</section>
